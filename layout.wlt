...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1854, y: 1048.5}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      ...
      m_LastClickedID: 0
      m_ExpandedIDs: 70fbffff72fbffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: ca410000
    m_LastClickedID: 16842
